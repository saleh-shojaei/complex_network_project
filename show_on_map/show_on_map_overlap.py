...
# ---------------- color map for dominant community ----------------
# فقط تا N جامعه‌ی پرتکرار را رنگی کن؛ بقیه «Other»
TOP_N = 20
...
# (A) dominant community per county
ax = axes[0]
# other (خاکستری)
...
# (B) overlap intensity (multi-membership rate) per county
ax = axes[1]
# فقط کانتی‌هایی که نقطه دارند
